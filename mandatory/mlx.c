...
void initialize_mlx(t_map_data *map_data)
{
	...
	map_data->tex.texture_east = mlx_xpm_file_to_image(map_data->mlx_ptr, "../img/eagle.xpm",
	...
	map_data->tex.texture_south = mlx_xpm_file_to_image(
			map_data->mlx_ptr, "../img/greystone.xpm", &map_data->tex.tex_width_south, &map_data->tex.tex_height_south);
	...
	map_data->tex.texture_west = mlx_xpm_file_to_image(map_data->mlx_ptr, "../img/mossy.xpm",
